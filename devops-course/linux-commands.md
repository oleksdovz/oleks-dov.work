...
Цей документ містить докладний опис основних команд Linux, приклади їх використання та пояснення.  
Особлива увага приділена командам для роботи із SSH, керування системними процесами та безпекою.
