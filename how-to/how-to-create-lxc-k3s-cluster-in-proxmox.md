...
- [Параметри кластера](#параметри-кластера)
- [Загальний алгоритм роботи скрипта](#загальний-алгоритм-роботи-скрипта)
- [Крок 1: Створення LXC контейнерів](#крок-1-створення-lxc-контейнерів)
- [Крок 2: Підготовка контейнерів для Kubernetes](#крок-2-підготовка-контейнерів-для-kubernetes)
- [Крок 3: Встановлення k3s master](#крок-3-встановлення-k3s-master)
- [Крок 4: Підключення k3s agent вузлів](#крок-4-підключення-k3s-agent-вузлів)
- [Керування та перевірка кластера](#керування-та-перевірка-кластера)
- [Видалення кластера](#видалення-кластера)
